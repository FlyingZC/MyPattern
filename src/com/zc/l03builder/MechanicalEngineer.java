...
public class MechanicalEngineer {
    ...
    public static void main(String[] args) {
        ...
        randBuilder.buildBase("王牌机" ).buildEngine("旋风引擎" ).buildInterior("mirrorss" ).buildLights("氪金灯" ).buildMirrors(
                "mirrors" ).buildRoof("屋顶" ).buildWheels("钢筋轮" );
    ...
    public void buildCar() {
        carBuilder.buildBase().buildWheels().buildEngine().buildRoof().buildMirrors().buildLights().buildInterior();
    }
}
